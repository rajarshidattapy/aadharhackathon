...
from backend.analytics.aflb import compute_aflb_alerts
from backend.analytics.bis import compute_bis_alerts
from backend.analytics.lost_generation import compute_lost_generation_alerts
from backend.analytics.urrdf import compute_urrdf_alerts
from backend.core.data_loader import get_dataset, get_merged_aadhaar_dataframe
from backend.schemas.biometric_alerts import (
...
class AnalyticsService:
    ...
    def predict_migration_model(self, month: Optional[str] = None, top_n: int = 10) -> pd.DataFrame:
        ...
        import numpy as np
        from backend.utils.migration_scoring import to_inflow_score, inflow_tier, recommendations_for_tier
