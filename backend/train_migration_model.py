...
DATA_PATH = REPO_ROOT / "data" / "merged_aadhaar_data_sample.csv"
MODEL_PATH = BACKEND_ROOT / "models" / "migration_score_model.pkl"
THRESHOLDS_PATH = BACKEND_ROOT / "models" / "migration_thresholds.pkl"
